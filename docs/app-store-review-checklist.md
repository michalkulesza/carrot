...
### 4. No public Support URL / contact page
...
### 5. Photo library permission forces full access instead of the limited picker (Guideline 5.1.1(iii))
...
### 6. Unused privacy purpose strings in `Info.plist`
...
### 7. Sensitive allergen/dietary data — consider a disclaimer
