...
const PublicRecipeDetailContent = ({
  recipe,
  token,
  primaryAction,
  primaryActionContent,
}: {
  recipe: PublicRecipeOut
  token: string
  ...
  return (
    <>
      ...
      <RecipeMetaBar
        ...
        onDecreaseServings={() =>
          setServings((value) => (value ? Math.max(1, value - 1) : value))
        }
        onIncreaseServings={() =>
          setServings((value) => (value ? Math.min(99, value + 1) : value))
        }
        onOpenCookMode={() => {}}
        readOnly
      ...
      <div className="mx-auto max-w-[800px] px-10 pb-5">
        ...
        {components.map((component, index) => (
          <ViewComponent
            ...
            servingScale={scale}
            collapsible={
              hasMultipleIngredientGroups && component.ingredients.length > 0
            }
