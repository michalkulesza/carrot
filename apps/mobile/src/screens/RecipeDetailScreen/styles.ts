...
export const styles = StyleSheet.create({
  ...
  relatedRecipeImage: { width: 29, height: 29, borderRadius: 8, backgroundColor: colors.gray6 },
  relatedRecipeTitle: { flex: 1, fontSize: 13, color: colors.label },
  relatedRecipeAdd: { width: 90, height: 41, borderRadius: 10, flexDirection: 'row', gap: 6, borderWidth: 1, borderStyle: 'dashed', borderColor: colors.opaqueSeparator, alignItems: 'center', justifyContent: 'center' },
